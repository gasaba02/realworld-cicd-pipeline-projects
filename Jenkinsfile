...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.53.136:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-agermain', //update and provide your channel name
